...
const mics = [
    "AKG C1000S", "AKG C3000B", "AKG C414BULS", "AKG C414B-XLII/ST", 
    "AKG C414B-XLS/ST", "AKG C451B/ST", "AKG C460-CKx", "AKG C480-CKx", 
    "ADK A51TL", "ADK SC-1", "ADK TL", "Audio Technica AT825", 
    "Audio Technica AT853a", "Audio Technica AT853Rx", "Audio Technica AT899", 
    "Audio Technica ES933/x", "Audio Technica 40xx", "Audix Micros 1245x", 
    "Audix Micros 1290x", "Audix Micros SCX1x", "Avantone CK-1", 
    "Busman BSC1", "Church-Audio B-99A", "Church-Audio CA-T2", 
    "Church-Audio STC-9000", "Core Sound (C-S) Battery Box", 
    "Core Sound Binaural", "Core Sound Budget Binaural", "Core Sound High End Binaural", 
    "Core Sound Low Cost Adapter", "Core Sound Low Cost Binaurals", 
    "Core Sound Low Cost Cardioids", "Core Sound Stealthy Cardioid", 
    "Core Sound Stealthy Cardioids", "DPA 4011", "DPA 4021", 
    "DPA 40xx (compact series)", "DPA 406x (mini series)", "Earthworks QTC30", 
    "Earthworks SR-30", "Earthworks SR-71", "Earthworks SR-77", 
    "Edirol R-05", "Edirol R-09", "Edirol R-09HR", "Edirol R4", 
    "Edirol R4 Pro", "Edirol R44", "Fostex DCR302", "Fostex FR-2", 
    "Fostex FR2LE", "Giant Squid Battery Box", "Giant Squid Cardioids", 
    "Giant Squid Omnis", "Grace Design Lunatec V2", "Grace Design Lunatec V3", 
    "Graham Patten ADC-20", "Graham Patten ADC-24", "Graham Patten DMIC-20", 
    "Graham Patten DMIC-24", "Hosa MIT-176", "MBHO 440", "MBHO 603-KAx", 
    "MBHO 603A-KAx", "MBHO MBP603A + KA", "Microtech Gefell M300", 
    "Microtech Gefell SMS2000-Mx", "Microtech-Gefell M930", "Neumann KM100-AKx (aka KM1x)", 
    "Neumann KM184", "Neumann KM18x", "Neumann TLM103", "Neumann TLM170", 
    "Neumann TLM170R", "Neumann U89", "Neumann U87Ai", "Nakamichi CM100-CPx", 
    "Nakamichi CM300-CPx", "Oktava MC012x (aka MK012x)", "Oktava MK-012", 
    "Peluso CEMC6", "Peluso P", "Rode NT1-A", "Rode NT4", "Rode NT5", 
    "Schoeps CCM + MK", "Schoeps CMC + MK", "Schoeps CMC6+MKx", 
    "Sound Professionals SP-AT831", "Sound Professionals SP-BMC-x", 
    "Sound Professionals SP-CMC-20", "Sound Professionals SP-CMC-2", 
    "Sound Professionals SP-CMC-2A", "Sound Professionals SP-CMC-4U", 
    "Sound Professionals SP-CMC-8", "Sound Professionals SP-CMC-9", 
    "Superlux CM-H8K/x", "Sennheiser MKH-8040", "Studio Projects C4", 
    "Studio Projects LSD2", "Tascam DR-40", "Tascam DR-100", 
    "Tascam DR-100 mkII", "Tascam HSP82", "Tascam HD-P2"
...
const recorders = [
    "Aaton Cantar X", "Alesis ProTrack [for iPod]", "Core Sound PDAudio-CF", 
    "Creative Labs Nomad JB3", "Denon DN-F20R", "Edirol R1", 
    "Edirol R4", "Edirol R-05", "Edirol R-09", "Edirol R-09HR", 
    "Edirol R09H", "Edirol R4 Pro", "Edirol R44", "Fostex DCR302", 
    "Fostex FR-2", "Fostex FR2LE", "HHB PortaDAT", "HHB PortaDrive", 
    "Korg MR-1000", "Korg MR-1", "Korg MR-2", "Marantz PMD 620", 
    "Marantz PMD 660", "Marantz PMD 661", "Marantz PMD 670", 
    "Marantz PMD 671", "M-Audio MicroTrack II", "Mini-Disc, traditional", 
    "Mini-Disc, Hi-MD", "Neuros HDxxGB Recorder", "Nagra Audio Nagra V", 
    "Nagra VI", "Olympus LS-10", "Olympus LS-10S", "Olympus LS-11", 
    "Olympus LS-12", "Olympus LS-14", "Olympus LS-20m", "Olympus LS-100", 
    "Pyle Pro PPR80", "Roland R-26", "Roland R-88", "Sound Devices 664", 
    "Sound Devices 702", "Sound Devices 702t", "Sound Devices 722", 
    "Sound Devices 744", "Sound Devices 744T", "Sony D100", 
    "Sony D7", "Sony D8", "Sony M1", "Sony M10", "Sony MZ-NH1 Hi-MD", 
    "Sony PCM-M1", "Sony TCD-D8", "Tascam DA-P1", "Tascam DR-100", 
    "Tascam DR-100 mkII", "Tascam DR-2d", "Tascam DR-40", 
    "Tascam DRV1-HD", "Tascam HSP82", "Tascam HD-P2", 
    "Zoom h4/h4n"
